...
export default AD.Model.extend('opstools.BuildApp.ABApplication',
    ...
    },
    {
        ...
        getPages: function (cond) {
            ...
            Object.keys(ABPage.store).forEach(function (storeKey) {
                var storePage = ABPage.store[storeKey];
                if (storePage.application) {
                    if (cond.application == storePage.application.id || storePage.application)
                        delete ABPage.store[storeKey];
                }
            });
